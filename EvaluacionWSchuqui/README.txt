...
a persistence unit "EvaluacionWSchuquiPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSchuqui\pom.xml":
...
artifact ("EvaluacionWSchuqui.war") is already built. You can build
